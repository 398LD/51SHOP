...
<table width="199" height="431"  border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="ordermanage.jsp?orderId=" >订单管理<br>
              Order Manage</a></td>
            </tr>
            
             <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="guestbook.jsp" >留言管理<br>
              Comment Manage</a></td>
            </tr>
             <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="news.jsp" >新闻管理<br>
              News Manage</a></td>
            </tr>
             <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="slideshow.jsp" >轮播图<br>
              Slideshow Manage</a></td>
            </tr>
             <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="slideshow.jsp" >主页预览<br>
              Slideshow Manage</a></td>
            </tr>
              <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="/shop/manage/bigData.html" >大数据<br>
              Big Data</a></td>
            </tr>
            <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="../LoginOut">退出后台<br>
