...
function onload(){
	...
	ajax.open('get','/shop/QLogin?access_token='+(window.location.hash.substring(1).split("&")[0].split("=")[1]));
	ajax.send(null);
	ajax.onreadystatechange=function()
	  ...
	  var json= JSON.parse(ajax.responseText);
		...
		if(json.nickname!=undefined){
			nic.innerHTML="你好!"+json.nickname;
			img.src=json.pictrue;
		}else{
			img.src="/shop/fromt/images/qqioc.png";
