...
<title>登录-51商城</title>
<link href="images/51logo.png" rel="icon" type="image/x-icon" />
...
data-appid="101543277"
data-redirecturi="http://kexun.iok.la/shop/fromt/index.jsp"
>
...
<body>
						...
						<form class="form-horizontal">
							<fieldset>
								...
								<div class="form-group" style="border-top: 1px solid #D9D9D9; margin: 20px;">
										<label style="color: gray;">第三方登录:</label>
										<a  id="qql" href="javascript:qqLogin()">
	...
	<script language="javascript">
		...
		function qqLogin(){
			window.location.href="https://graph.qq.com/oauth2.0/authorize?response_type=token&client_id=101543277&redirect_uri=http://kexun.iok.la/shop/fromt/index.jsp&scope=4775546"
